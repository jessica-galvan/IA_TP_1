...
Shader "ToonShader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 Diffuse18 = ( float4( ( temp_output_8_0 + ( ( 1.0 - temp_output_8_0 ) * indirectDiffuse11 ) ) , 0.0 ) * ase_lightColor * ( tex2D( _Color, uv_Color ) * color17 ) );
...
Node;AmplifyShaderEditor.SamplerNode;15;320.081,470.3815;Inherit;True;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;-1;None;cffb506ec5b6cc94498def65473d32ed;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CDC35F5B57338AC83C607F9B1B36E7FC1086D051